...
$("select").html(`
    ...
    <option data-countrycode="SG" value="+65">Singapo4re (+65)</option>
...
let apiDataGet = async () => {
    let data = getProjectData(343)       // Change Project_ID Integer Value only Ex:1131
        .then((data) =>{ 
        ...
        .catch((error) => {
            var whatsapp_url = "https://api.whatsapp.com/send?phone=8792740459&text=Hi!"
            $(".whatsapp_url").attr("href", whatsapp_url);
            $(".phone_url").attr("href", "tel:" + 8792740459 + "");
            $(".phone_no").html("8792740459")
        });
}    
apiDataGet();
// UTM Data Call
...
// main function to store the data and post data to api
    ...
    $('#OnLaodForm').on("submit", function () {
        ...
        var country_code = $('#OnLaod_CountryCode').val();
        var checkbox = $('#modal_checkbox').val();
        saveLead(name, email, number, country_code,checkbox, ' onlaodform_overview_homepage');
        return !1
    })
