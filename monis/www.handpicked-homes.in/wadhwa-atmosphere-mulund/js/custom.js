...
$('[data-target]').on('click', function () {
    ...
    Title = {
        ...
        'LocationSection': "Due to huge rush at site we would request you to book your sitevisit in advance",
        'VideoSection': "Get complete 360 view of the project",
        'GallerySection': "Inside features of the project at a glance",
...
let apiDataGet = async () => {
    let data = getProjectData(337) // Change Project_ID Integer Value only Ex:1131
        .then((data) => {
...
$('#dropAnEnquiry').on("submit", function () {
    ...
    var countrycode = $('#dropAnEnquiry_CountryCode').val();
    var checkbox = $('#dropAnEnquiry_checkbox').val();
    saveLead(name, email, number, countrycode, checkbox, 'top_enquire_form');
    return false;
})
$('#ModalForm').on("submit", function () {
    ...
    var countrycode = $('#Modal_CountryCode').val();
    var checkbox = $('#Modal_checkbox').val();
    saveLead(name, email, number, countrycode, checkbox, id + '_overview_homepage');
    return false;
})
$('#OnLaodForm').on("submit", function () {
    ...
    var countrycode = $('#OnLaod_CountryCode').val();
    var checkbox = $('#OnLaod_checkbox').val();
    saveLead(name, email, number, checkbox, ' onlaodform_overview_homepage');
    return false;
})


async function saveLead(name, email, number, countrycode, checkbox, pref) {
    debugger;
