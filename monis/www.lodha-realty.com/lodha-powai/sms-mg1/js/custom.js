...
let apiDataGet = async () => {
    let data = getProjectData(1553)       // Change Project_ID Integer Value only Ex:1131
        .then((data) =>{ 
            debugger;
...
var param_nationality = 1;
    ...
    $('#dropAnEnquiry').on("submit", function () {
        ...
        var country_code = $('#dropcountrycode').val();
    ...
    obj.magnet_id = 416800 ; //if magnet else blank (int)
    obj.source_id = 14;
