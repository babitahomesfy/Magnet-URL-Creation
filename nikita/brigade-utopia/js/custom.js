...
$('[data-target][data-toggle=modal]').on('click', function() {
    ...
    Title = {
        ...
        'video_call': 'Virtual Zoom Meetings - With The Regency Anantam Dombivali Experts',
...
$(document).ready(function() {
    ...
    let apiDataGet = async () => {
        let data = getProjectData(1153) // Change Project_ID Integer Value only Ex:1131
            .then((data) => {
    ...
    $('#dropAnEnquiry').on("submit", function() {
        ...
        var countrycode = $('#drop_CountryCode').val();
        saveLead(name, email, number, countrycode, 'top_enquire_form');
        return !1
    })
    $('#PriceForm').on("submit", function() {
        ...
        var countrycode = $('#Price_CountryCode').val();
        saveLead(name, email, number, countrycode, id+'_overview_homepage');
        return !1
    })
    $('#OnLaodForm').on("submit", function() {
        ...
        saveLead(name, email, number, countrycode, ' onlaodform_overview_homepage');
        return !1
    })

    async function saveLead(name, email, number, countrycode, pref) {
        debugger;
