...
$('[data-target][data-toggle=modal]').on('click', function() {
    ...
    Title = {
        ...
        'VirtualTour': "Talk to our Experts on a video call / get digitally  connected on a video call.",
        'DownloadBrochure': "Mention your whatsapp number to receive Brochure on whatsapp.",
        'EnquireNow': "Put your interests in action, get all the details right now.",
        ...
        'BookSiteVisit': "Due to huge rush at site we would request you to book your sitevisit in advance.",
...
// ********** captcha code for dynamic form start here
/*    
    $(function () {
        $('#dropAnEnquiry').ebcaptcha();
        $('#ModalForm').ebcaptcha();
    });
    ...
    (function ($) {
        ...
        jQuery.fn.ebcaptcha = function (options) {
            ...
            randomNr2 = Math.floor(Math.random() * 100);
...
*/
// ********** captcha code for dynamic form end here 
...
$('#ModalForm').on("submit", function() {
    ...
    var country_code = $('#Modal_CountryCode').val();
...
$('#PopUpForm').on("submit", function() {
    ...
    saveLead(name, email, number, country_code, checkbox, 'PopUp_overview_homepage');
    return !1
})
