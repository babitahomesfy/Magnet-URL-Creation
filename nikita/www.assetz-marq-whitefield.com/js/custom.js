...
let apiDataGet = async () => {
    let data = getProjectData(1491)       // Change Project_ID Integer Value only Ex:1131
        .then((data) =>{ 
...
var param_nationality = 1;
    ...
    $('#ModalForm').on("submit", function () {
        ...
        saveLead(name, email, number, country_code ,id+'_overview_homepage');
        return !1
    })
    $('#PopUpForm').on("submit", function () {
        ...
        saveLead(name, email, number, country_code , 'PopUp_form_overview_homepage');
        return !1
    }) 
    $('#priceForm').on("submit", function () {
        debugger;
        var name = $('#pric_ename').val();
        var email = "Noe email";
        var number = $('#price_number').val();
        var country_code = $('#price_CountryCode').val();
        // var checkbox = $('#price_checkbox').val();
        saveLead(name, email, number, country_code, 'price_form_overview_homepage');
        return !1
    }) 
     $('#price1Form').on("submit", function () {
        debugger;
        var name = $('#price1_name').val();
        var email = "Noe email";
        var number = $('#price1_number').val();
        var country_code = $('#price1_CountryCode').val();
        // var checkbox = $('#price1_checkbox').val();
        saveLead(name, email, number, country_code, 'price1_form_overview_homepage');
        return !1
    }) 
    $('#price2Form').on("submit", function () {
        debugger;
        var name = $('#price2_name').val();
        var email = "Noe email";
        var number = $('#price2_number').val();
        var country_code = $('#price2_CountryCode').val();
        // var checkbox = $('#price2_checkbox').val();
        saveLead(name, email, number, country_code, 'price2_form_overview_homepage');
        return !1
    }) 
    $('#price3Form').on("submit", function () {
        debugger;
        var name = $('#price3_name').val();
        var email = "Noe email";
        var number = $('#price3_number').val();
        var country_code = $('#price3_CountryCode').val();
        // var checkbox = $('#price3_checkbox').val();
        saveLead(name, email, number, country_code, 'price3_form_overview_homepage');
        return !1
    }) 
    $('#price4Form').on("submit", function () {
        debugger;
        var name = $('#price4_name').val();
        var email = "Noe email";
        var number = $('#price4_number').val();
        var country_code = $('#price4_CountryCode').val();
        // var checkbox = $('#price4_checkbox').val();
        saveLead(name, email, number, country_code, 'price4_form_overview_homepage');
        return !1
    }) 
    $('#price5Form').on("submit", function () {
        debugger;
        var name = $('#price5_name').val();
        var email = "Noe email";
        var number = $('#price5_number').val();
        var country_code = $('#price5_CountryCode').val();
        // var checkbox = $('#price5_checkbox').val();
        saveLead(name, email, number, country_code, 'price5_form_overview_homepage');
        return !1
    }) 
    $('#price6Form').on("submit", function () {
        debugger;
        var name = $('#price6_name').val();
        var email = "Noe email";
        var number = $('#price6_number').val();
        var country_code = $('#price6_CountryCode').val();
        // var checkbox = $('#price6_checkbox').val();
        saveLead(name, email, number, country_code, 'price6_form_overview_homepage');
        return !1
    }) 
    $('#price7Form').on("submit", function () {
        debugger;
        var name = $('#price7_name').val();
        var email = "Noe email";
        var number = $('#price7_number').val();
        var country_code = $('#price7_CountryCode').val();
        // var checkbox = $('#price7_checkbox').val();
        saveLead(name, email, number, country_code, 'price7_form_overview_homepage');
        return !1
    }) 


   async function  saveLead(name, email, number, country_code, pref) {
    debugger;
