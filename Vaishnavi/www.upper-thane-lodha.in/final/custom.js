...
let apiDataGet = async () => {
    let data = getProjectData(144)       // Change Project_ID Integer Value only Ex:1131
        .then((data) =>{ 
...
$('#dropAnEnquiry').on("submit", function () {
        ...
        $('#HomeForm').on("submit", function () {
            ...
            var email = "Noe email";
            var number = $('#Homenumber').val();
            var country_code = $('#Home_CountryCode').val();
            var checkbox = $('#checkbox').val();
            saveLead(name, email, number, country_code,checkbox, 'Home_form_homepage');
            return false;
        ...
        $('#OfferModalForm').on("submit", function () {
            ...
            var country_code = $('#OfferModal_CountryCode').val();
            var checkbox = $('#checkbox').val();
            saveLead(name, email, number, country_code,checkbox, 'specialoffer_overview_homepage');
            return false;
        })
        $('#BannerForm').on("submit", function () {
            ...
            var country_code = $('#Banner_CountryCode').val();
            var checkbox = $('#checkbox').val();
            saveLead(name, email, number, country_code,checkbox, 'Banner_overview_homepage');
            return false;
        })
        ...
        $('#BrochureForm').on("submit", function () {
            ...
            var checkbox = $('#checkbox').val();
            saveLead(name, email, number, country_code,checkbox, 'Brochure_overview_homepage');
            return false;
        })
        $('#onloadForm').on("submit", function () {
            ...
            var checkbox = $('#checkbox').val();
            saveLead(name, email, number, country_code,checkbox, 'onload_overview_homepage');
            return false;
        })
