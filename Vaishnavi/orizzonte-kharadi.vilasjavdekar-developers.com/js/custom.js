...
mainListDiv = document.getElementById("mainListDiv"),
    mediaButton = document.getElementById("mediaButton");
mediaButton.onclick = function() {
    "use strict";
    mainListDiv.classList.toggle("show_list"), mediaButton.classList.toggle("active")
    ...
    $(".Wuidth100").each(function(t) {
        $(this).position().top <= e && ($(".nav a.active").removeClass("active"), $(".nav a").eq(t).addClass("active"))
    })
...
$('[data-target]').on('click', function() {
    ...
    Title = {
        ...
        'VirtualTour': "Get complete 360 view of the project",
        'video_call': 'Schedule Virtual Zoom Meetings - With The Runwal MyCity Dombivli Experts',
        'special_offer':"We've got a special offer only for you",
        'Gallery_section':"Inside features of the project at a glance"
    }

    // console.log("hello kjhsdkjfhsd",Title[id])
...
let apiDataGet = async () => {
    let data = getProjectData(1109) // Change Project_ID Integer Value only Ex:1131
        .then((data) => {
...
//             n._.push(e)
//         },
//         o = n.s = e.createElement(t),
//         a = e.getElementsByTagName(t)[0];
//     n.set = function(e) {
//         n.set._.push(e)
//     }, n._ = [], n.set._ = [], o.async = !0, o.setAttribute("charset", "utf-8"), o.src = "//v2.zopim.com/?2F4uasrDz8AwB7cxrCz3igHZtZovK0w4", n.t = +new Date, o.type = "text/javascript", a.parentNode.insertBefore(o, a)
