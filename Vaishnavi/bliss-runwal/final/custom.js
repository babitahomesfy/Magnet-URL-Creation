...
// Checkbox Status Check or Uncheck
...
let apiDataGet = async () => {
    let data = getProjectData(174)       // Change Project_ID Integer Value only Ex:1131
        .then((data) =>{ 
...
$('#dropAnEnquiry').on("submit", function () {
        ...
        $('#HomemeetingForm').on("submit", function () {
            ...
            var checkbox = $('#checkbox').val();
            saveLead(name, email, number, country_code,checkbox, ' homemeeting_overview_homepage');
            return !1
        })
        $('#BrochureForm').on("submit", function () {
            ...
            var checkbox = $('#checkbox').val();
            saveLead(name, email, number, country_code,checkbox, 'downloadbrochure_overview_homepage');
            return !1
        })
        $('#PriceForm').on("submit", function () {
            ...
            var checkbox = $('#checkbox').val();
            saveLead(name, email, number, country_code,checkbox, ' priceplan_overview_homepage');
            return !1
        })
        $('#OfferModalForm').on("submit", function () {
            ...
            var country_code = $('#drop_CountryCode').val();
            var checkbox = $('#checkbox').val();
            saveLead(name, email, number, country_code,checkbox, 'gallery_overview_homepage');
            return !1
        })
        $('#AmenitiesForm').on("submit", function () {
            ...
            var checkbox = $('#checkbox').val();
            saveLead(name, email, number, country_code,checkbox, ' amenities_overview_homepage');
            return !1
        })
        $('#FloorPlanForm').on("submit", function () {
            ...
            var checkbox = $('#checkbox').val();
            saveLead(name, email, number, country_code,checkbox, ' floorplan_overview_homepage');
            return !1
        })
        $('#LocationForm').on("submit", function () {
            ...
            var checkbox = $('#checkbox').val();
            saveLead(name, email, number, country_code,checkbox, ' sitevisit_overview_homepage');
            return !1
        })
        $('#EmiFormModal').on("submit", function () {
            ...
            var checkbox = $('#checkbox').val();
            saveLead(name, email, number, country_code,checkbox, 'emicalculator_overview_homepage');
            return !1
        })
        $('#KnowMoreForm').on("submit", function () {
            ...
            var checkbox = $('#checkbox').val();
            saveLead(name, email, number, country_code,checkbox, 'Know_more_details_overview_homepage');
            return !1
        })
        $('#FeatureForm').on("submit", function () {
            ...
            var checkbox = $('#checkbox').val();
            saveLead(name, email, number, country_code,checkbox, 'featured_porject_details_overview_homepage');
            return !1
        })
        $('#GalleryForm').on("submit", function () {
            ...
            var checkbox = $('#checkbox').val();
            saveLead(name, email, number, country_code,checkbox, 'video_gallery_overview_homepage');
            return !1
        })
