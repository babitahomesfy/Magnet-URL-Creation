...
let baseUrl = window.location.href.includes("file")  || window.location.href.includes("localhost")?"https://staging-api.homesfy.in/":"https://api.homesfy.in/"
...
let getProjectData = async (project_id) => {
    ...
    return await  $.get(api_url) 
        ...
        const api_url = baseUrl+"https://api.homesfy.in/api/leads/projectdata/"+ project_id;
        // console.log(api_url)
    return await  $.get(api_url) 
        // return api_url;
    }
